...
vecNp=(5:5:40);
Params=struct('R',R, 'Rp', Rp,'J',Jrhoz,'mu',4*pi*1e-7,'MRW',5,'DeltaDif',1e-6, 'test',0);
...
Params=struct('R',R, 'Rp', Rp,'J',Jrhoz,'mu',4*pi*1e-7,'MRW',30,'DeltaDif',1e-6, 'test',0);
...
xvec=linspace(0.1,R+5*0.15,5); x=xvec;
zvec=linspace(-5*0.15,5*0.15,5); z=zvec;
