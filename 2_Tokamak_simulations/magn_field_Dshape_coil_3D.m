...
% approximated by N_segments straight segments. The coil is oriented
...
function [output]=magn_field_Dshape_coil_3D(I,r_evaluate_B,c_coil,coords_local_coil,rotations)
global mu0  
